...
trainDataDirPath = "../data/train-test-split/train/"

# Optimizer parameters
optimizerLearningRate = 1e-3

# Early stopping
earlyStoppingAccuracy = 0.732
...
# Load data
print("Loading data...")
x_text, y = data_helpers.load_data_and_labels(trainDataDirPath)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # optimizer      = tf.train.AdadeltaOptimizer(optimizerLearningRate)
        optimizer      = tf.train.AdamOptimizer(optimizerLearningRate)
        ...
        def dev_step(x_batch, y_batch, writer=None):
            ...
            return (accuracy > earlyStoppingAccuracy)
        ...
        for batch in batches:
            ...
            if current_step % FLAGS.evaluate_every == 0:
                print("\nEvaluation:")
                earlyStop = dev_step(x_dev, y_dev, writer = dev_summary_writer)

                # Early Stopping
                if earlyStop == True:
                    print('[Training Interrupt] Early Stopping condition encountered.')
